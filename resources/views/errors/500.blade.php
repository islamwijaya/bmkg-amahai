...
<div class="min-h-[60vh] flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full text-center">
        <div class="mb-8">
            <h1 class="text-9xl font-extrabold text-red-600 opacity-10">500</h1>
            <div class="-mt-20">
        ...
        <h2 class="text-3xl font-bold text-bmkg-navy mb-4">Kesalahan Server Internal</h2>
        <p class="text-gray-600 mb-8 leading-relaxed">
            Maaf, terjadi kesalahan pada server kami. Masalah ini telah dilaporkan kepada tim teknis kami. Silakan coba memuat ulang halaman.
        </p>
