...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Data akan tampil di halaman SDM publik</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.pegawai.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 space-y-5">
            ...
            <div x-data="{ previewUrl: null }" class="flex items-start gap-5">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-400 mt-1.5">Opsional. Format: JPG, PNG. Maks 2MB.</p>
            ...
            <div>
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                       ...
                       placeholder="Cth: Ir. Ahmad Fauzi, M.Si">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="jabatan" name="jabatan" list="jabatan-options" value="{{ old('jabatan') }}"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="pendidikan" name="pendidikan" value="{{ old('pendidikan') }}"
                           ...
                           placeholder="Cth: S2 Meteorologi">
                ...
                <div>
                    ...
                    <input type="text" id="golongan" name="golongan" value="{{ old('golongan') }}" maxlength="10"
            ...
            <div>
                ...
                <input type="number" id="urutan" name="urutan" value="{{ old('urutan', 0) }}" min="0"
                       class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-bmkg-blue/30 focus:border-bmkg-blue transition-colors @error('urutan') border-red-400 @enderror">
                <p class="text-xs text-gray-400 mt-1">Angka kecil tampil pertama. Kepala Stasiun biasanya 0.</p>
