            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="is_ketua_tim" name="is_ketua_tim"
                        ...
                        <option value="0" @selected(old('is_ketua_tim', $pegawai->is_ketua_tim) == '0')>Anggota Tim</option>
                        <option value="1" @selected(old('is_ketua_tim', $pegawai->is_ketua_tim) == '1')>Ketua Tim</option>
                    </select>
